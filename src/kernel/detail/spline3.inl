    ...
    )
{
  ...
  //  if(TIX==0 and TIY==0 and TIZ==0 and BIX==0 and BIY==0 and BIZ==0)
   // printf("lv1\n");
     ...
     ******************************************************************************/
   // if (TIX == 0 and BIX == 0 and BIY == 0 and BIZ == 0) { spline3d_print_block_from_GPU<T2,false>(s_ectrl); }
     if (TIX == 0 and BIX == 6 and BIY == 24 and BIZ == 16) { spline3d_print_block_from_GPU<T2,false>(s_ectrl); }
